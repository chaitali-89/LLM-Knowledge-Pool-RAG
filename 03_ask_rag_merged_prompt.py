...
embeddings_json= "knowledge_pool\International_Residential_Code - Mean of Egress.json"
...
question = "Indicate values only the width, depth and height of stairways, not spiral stairways and indicate what type of stair?"
