...
import json
from config import *
#from config import api_mode, embedding_model


embeddings_json= "knowledge_pool/Indian Standard_ CODE OF PRACTICE FOR FIRE SAFETY OF BUILDINGS (GENERAL)_ EXIT REQUIREMENTS AND PERSONAL HAZARD.json"
...
question = "What is the staircase tread size for Indian Standard?"
